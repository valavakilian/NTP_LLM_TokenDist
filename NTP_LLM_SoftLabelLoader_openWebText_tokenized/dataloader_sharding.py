...
if __name__ == "__main__":
    ...
    dataset_dir = f'/scratch/st-cthrampo-1/vaalaa/openWebText_tokinzed/openwebtext_data/processed/train_{args.tokenizer_type}_gpt2style.bin'  # Your saved dataset folder
