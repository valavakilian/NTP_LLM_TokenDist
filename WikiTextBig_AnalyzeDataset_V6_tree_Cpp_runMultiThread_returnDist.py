...
if __name__ == "__main__":
    ...
    vocab_source = "custom"
    AR_training = True
    save_tree_folder =  "/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TokenDist_WikiBig_multithreaded/context_trees_memap_cpp/"
    save_graph_folder = "/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TokenDist_WikiBig_multithreaded/graph_trees_cpp/"
    save_logs_folder =  "/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TokenDist_WikiBig_multithreaded/logs_trees_cpp/"
    ...
    try:
        ...
        milestones = generate_equal_spaced_points(num_examples, 1000)[1:] # exclude zero
        ...
        for X in dataloader:
            ...
            if contexts_count <= up_to_ctx_count_processed: 
                ...
                # print(X[0:100, :].shape)
                soft_labels = context_tree.insert(X)
