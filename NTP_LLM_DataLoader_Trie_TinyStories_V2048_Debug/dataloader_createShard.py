...
if __name__ == "__main__":
    ...
    print("_" * 100)
    print("Creating Trie ... ")
    # print("bin_assigned_indices: " + str(bin_assigned_indices))
    # print("valid_indices are: " + str(valid_indices))
    # print("num valid_indices: " + str(len(valid_indices)))
    print("All contexts input: ")
    ...
    #     print(str(pos) + " : " + str(sequence[pos:pos + args.context_length]))
    # input()
    # Get the dataset objectf
