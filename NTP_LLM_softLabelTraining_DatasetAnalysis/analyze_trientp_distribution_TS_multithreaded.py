...
def load_or_create_tree(args, memap_filename, dataloader, num_milestones, num_examples):
    ...
    save_tree_folder =  "/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TinyStories/Trie_CPP_saves_multithreaded/context_trees_memap_cpp/"
    save_graph_folder = "/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TinyStories/Trie_CPP_saves_multithreaded/graph_trees_cpp/"
    save_logs_folder =  "/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TinyStories/Trie_CPP_saves_multithreaded/logs_trees_cpp/"
    ...
    context_tree = trie_module_protV1_lib_multithreaded.Trie_module_protV1(memap_filename, 200, args.context_length)
    ...
    for X in tqdm(dataloader):
        ...
        if contexts_count <= up_to_ctx_count_processed: 
            ...
            insert_runtime += timer() - start_time_insert
            del X
...
if __name__ == "__main__":
    ...
    processor.process(
        ...
        output_dir=f"/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TinyStories/data_saves/tokenized_data_multithreaded"
    )

    print("Data processed. ")

    dataset = TinyStoriesDataset(
        data_dir=f"/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TinyStories/data_saves/tokenized_data_multithreaded",
