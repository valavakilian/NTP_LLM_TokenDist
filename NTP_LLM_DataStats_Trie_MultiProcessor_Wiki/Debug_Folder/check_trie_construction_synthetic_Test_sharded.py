...
if __name__ == "__main__":
    ...
    save_Trie_folder = "/scratch/st-cthrampo-1/vaalaa/NTP_LLM_DataStats_Trie_MultiProcessor_Wiki/Debug_Files/Tries_synthetic/"
    ...
    num_milestones = 10
    context_tree_ST = load_or_create_tree_single(args, single_thread_folder_path, dataloader, num_milestones, num_ctx)
