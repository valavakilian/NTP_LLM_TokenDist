...
if __name__ == "__main__":
    ...
    try:
        ...
        plt.yscale("log")
        plt.legend()
        plt.savefig("/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TokenDist_WikiBig_childDict_V2/graphs_trees_cpp_postprocess/entropy_vs_voc_ctxLen.jpg")
        ...
        plt.xscale("log")
        plt.legend()
        plt.savefig("/scratch/st-cthrampo-1/vaalaa/NTP_LLM_TokenDist_WikiBig_childDict_V2/graphs_trees_cpp_postprocess/entropy_ctxLen64_vs_vocSize_for_ctxSeen.jpg")
